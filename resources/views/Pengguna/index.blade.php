...
<head>
        ...
        <meta charset="utf-8" />
        <title>Pengguna | Inventory barang</title>
            ...
            <div class="left-side-menu">
                ...
                <div class="h-100" data-simplebar>
                    ...
                    <div class="user-box text-center">
                        ...
                        <img src="{{asset('Admin/images/users/user-1.jpg')}}" alt="user-img" title="Mat Helme" class="rounded-circle img-thumbnail avatar-md">
                            <div class="dropdown">
                        ...
                        <p class="text-muted left-user-info">Inventory barang SMK MVP</p>
